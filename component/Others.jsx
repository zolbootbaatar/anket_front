  ...
  return (
    <div className="relative p-6 border border-gray-400">
      ...
      <div className="py-6">
        ...
        {renderTextarea(formData.futureGoal, (e) =>
          updateField("futureGoal", e.target.value)
        )}
      </div>
      ...
      <div className="py-6 text-[12px]">
        ...
        {readOnly ? (
          ...
          <div className="flex flex-wrap gap-4">
            {[
              ...
              " Facebook, website",
              "Манайхтай холбоо барьж, эсвэл өөрөө ирж",
        ...
        {formData.jobInfoSource ===
          "Бусад: /Дээр дурьдаагүй ямар мэдээллийн сувгаар/" &&
          renderInput(formData.otherJobSource, (e) =>
            updateField("otherJobSource", e.target.value)
          )}
      </div>
