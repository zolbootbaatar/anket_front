...
const PersonalData = ({ onChange, defaultValue = [], readOnly = false }) => {
  ...
  return (
    <div
      className="relative border px-2 border-gray-400 md:p-6 mx-auto"
    >
      ...
      <div className="py-2 flex md:flex-wrap md:gap-14 gap-6 items-center">
        ...
        <div className="flex items-center md:gap-30 ml-14 md:ml-17">
          <label className="text-[10px] md:text-[12px] font-medium mr-2">Хүйс:</label>
      ...
      <div className="py-2 flex md:flex-wrap gap-7 md:gap-21 items-center">
        <div className="flex items-center md:gap-27">
          <label className="text-[10px] md:text-[12px] whitespace-nowrap mr-2">Төрсөн:</label>
          ...
          >
            ...
            {years.map((year) => (
              <option key={year} value={year} className="text-[#0000ff] max-md:h-[15px] text-[10px] md:text-[12px]">
                {year}
              </option>
            ))}
          </select>
          ...
          >
            ...
            {days.map((day) => (
              <option key={day} value={day} className="text-[#0000ff] max-md:h-[15px] text-[10px] md:text-[12px]">
                {day}
              </option>
            ))}
          </select>
      ...
      <div className="py-4 md:py-6 flex-wrap space-y-2 md:space-y-4">
        <div className="flex items-center gap-4 md:gap-10 ">
          <label className="md:text-[12px] text-[10px]" htmlFor="currentAddress">
      ...
      <h1 className="md:py-4 py-2 text-[10px] md:text-[12px]">Яаралтай үед холбоо барих 3 хүний нэр, утасны дугаар:</h1>

      <div className="py-2 space-y-1 md:space-y-5">
          <div className="flex items-center gap-4 md:gap-20">
          <label className="text-[10px] md:text-[12px]">1. Таны хэн болох, нэр, утас:</label>
          <input
            type="text"
        ...
        <div className="flex items-center gap-4 md:gap-20">
          <label className="text-[10px] md:text-[12px]">2. Таны хэн болох, нэр, утас:</label>
          <input
            type="text"
          ...
          <div className="flex items-center gap-4 md:gap-20">
          <label className="text-[10px] md:text-[12px]">3. Таны хэн болох, нэр, утас:</label>
          <input
            type="text"
      ...
      <div className="py-6 flex items-center space-x-2 md:gap-4 text-[10px] md:text-[12px]">
        <label className="block mb-2 ">Таны найз, эсвэл төрөл садан манай байгууллагад ажилладаг эсэх:</label>
     
          <div className="flex space-x-4 text-[12px] md:text-[12px]">
            {["Үгүй", "Тийм"].map((choice) => (
              <label key={choice} className="flex items-center space-x-2 text-[10px] md:text-[12px]">
                <input
                  type="radio"
