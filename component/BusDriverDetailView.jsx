...
const BusDriverDetails = ({ value }) => {
  ...
  const handleChange = (e) => {
    // Энэ функц хоосон - форм уншихад л зориулсан
    return;
  };
      ...
      <div className="grid md:grid-cols-2 gap-4">
        ...
        <label className="flex items-center space-x-2 py-4">
          <input
            ...
            checked={form.hasPreviousOwner || false}
            onChange={handleChange}
            disabled
          />
      ...
      <div className="flex flex-col space-y-2 ml-4">
        <label className="py-2 flex items-center">
          <input
            type="checkbox"
            name="purpose.sell"
            checked={form.purpose?.sell || false}
            onChange={handleChange}
            disabled
          />{" "}
        ...
        <label className="py-2 flex items-center">
          <input
            type="checkbox"
            name="purpose.rent"
            checked={form.purpose?.rent || false}
            onChange={handleChange}
            disabled
          />{" "}
        ...
        <label className="py-2 flex items-center">
          <input
            ...
            checked={form.purpose?.incomeUse || false}
            onChange={handleChange}
            disabled
          />{" "}
        ...
        <label className="py-2 flex items-center space-x-2">
          <input
            type="checkbox"
            name="purpose.other"
            checked={form.purpose?.other || false}
            onChange={handleChange}
            disabled
          />
