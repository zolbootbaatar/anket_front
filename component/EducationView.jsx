...
const Education = ({
  ...
  useEffect(() => {
    if (
      ...
      defaultValue.computerSkills &&
      defaultValue.personalSkills
    ) {
      setSchools(defaultValue.schools);
      setComputerSkills(defaultValue.computerSkills);
      setPersonalSkills(defaultValue.personalSkills);
    }
  }, [defaultValue]);
      ...
      <table className="table-auto w-full border border-gray-300 mt-4">
        <thead>
          <tr>
            ...
            <th className="border px-2 py-1 text-[13px]">
              Элссэн он, сар, өдөр
            </th>
            <th className="border px-2 py-1 text-[13px]">
              Төгссөн он, сар, өдөр
        ...
        <tbody>
          {schools.map((school, index) => (
            <tr key={index}>
              <td className="border px-3 py-1 text-center text-[13px]">
                {school.schoolType}
              </td>
              {[
                "schoolName",
